...
namespace EngineStudy.LayerMange
{
    ...
    /// </summary>
    [Guid("b8c7bc92-362f-4137-a073-c6e3392605f5")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("EngineStudy.LayerMange.OpenAttributeTable")]
    public sealed class OpenAttributeTable : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            AttributeTableFrm frm=new AttributeTableFrm();
            frm.CreateAttributeTable(m_pLayer);
            frm.ShowDialog();
        }
